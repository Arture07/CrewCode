...
import com.crewcode.sessionservice.dto.FileData;
import com.crewcode.sessionservice.dto.TreeNode;
import com.crewcode.sessionservice.model.CodingSession;
import com.crewcode.sessionservice.repository.CodingSessionRepository;
...
public class TreeSessionService {
    ...
    private final com.crewcode.sessionservice.repository.FileHistoryRepository historyRepo;
    private final com.crewcode.sessionservice.repository.SessionFileRepository sessionFileRepo;

    public TreeSessionService(CodingSessionRepository repo, ObjectMapper mapper, 
                              com.crewcode.sessionservice.repository.FileHistoryRepository historyRepo,
                              com.crewcode.sessionservice.repository.SessionFileRepository sessionFileRepo) {
        this.repo = repo;
        this.mapper = mapper;
    ...
    private void extractFiles(TreeNode node, String currentPath, String sessionPublicId, List<com.crewcode.sessionservice.model.SessionFile> files) {
        if (node == null) return;
        
        com.crewcode.sessionservice.model.SessionFile sf = new com.crewcode.sessionservice.model.SessionFile();
    ...
    private TreeNode buildTreeFromFiles(List<com.crewcode.sessionservice.model.SessionFile> files) {
        TreeNode root = TreeNode.folder("");
        
        for (com.crewcode.sessionservice.model.SessionFile f : files) {
    ...
    private TreeNode loadRootAndMigrateIfNeeded(CodingSession session) throws Exception {
        List<com.crewcode.sessionservice.model.SessionFile> existingFiles = sessionFileRepo.findBySessionPublicId(session.getPublicId());
    ...
    protected void persist(CodingSession session, TreeNode root) throws Exception {
        ...
        // Save new tree
        List<com.crewcode.sessionservice.model.SessionFile> files = new ArrayList<>();
    ...
    public void updateFileContent(String publicId, String path, String content) throws Exception {
        ...
        Optional<com.crewcode.sessionservice.model.SessionFile> existing = sessionFileRepo.findBySessionPublicIdAndFilePath(publicId, cleanPath);
        if (existing.isPresent()) {
            com.crewcode.sessionservice.model.SessionFile file = existing.get();
    ...
    public void createSnapshot(String publicId, String path, String content, String username) {
        com.crewcode.sessionservice.model.FileHistory history = new com.crewcode.sessionservice.model.FileHistory();
    ...
    @Transactional(readOnly = true)
    public List<com.crewcode.sessionservice.model.FileHistory> getFileHistory(String publicId, String path) {
